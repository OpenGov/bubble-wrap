Feature: Entity user actions with 'View Shared Proposals' access
  ...
  Background:
    ...
    And default_subdomain entity_user has 'View Shared Proposals' access
...
#    And I go to budgets from reports page
  ...
  @bvt
  Scenario: can not create the proposal
